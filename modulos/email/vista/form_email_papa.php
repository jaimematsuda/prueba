...
PRECIO DE PAPA
		...
		<br />
		<br />
		<?php data_to_table_mail($proveedor_papa, "precio x bolsa"); ?>
		<span>Notas :</span>
		<br />
...
skina@macroscem.com
		...
		&nbsp; &nbsp;
		<input type="button" id="enviaemail" name="enviaemail" value="Enviar Email Papa" />
		<br />
	</form>
</div>
