<div>
	...
	<input type="texbox" id="vigencia_inicio" name="vigencia_inicio" value="Vigencia inicio" size="10px" readonly />
	&nbsp;
	<input type="texbox" id="vigencia_final" name="vigencia_final" value="Vigencia final" size="10px" readonly />
	<br /><br />
