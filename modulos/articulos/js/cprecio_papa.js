$(function() {
	...
	$("#enviardtdb").click(function() {
		...
		var campo1, campo2, campo3, campo4, campo5, campo6, campo7, campo8;
			...
			$.post("index.php?modulo=edicion&pagina=cprecio_papa", {id_pvd: campo1, vigencia_inicio: campo3, vigencia_final: campo4, unidad: campo7, precio: campo8});
		});
		$("#formMail").show();
		$("#enviardtdb").hide();
	});	
