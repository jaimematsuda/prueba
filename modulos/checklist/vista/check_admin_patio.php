<div class="checklist">
	<table border="1">
		<caption>CHECK LIST ADMINISTRADORES PATIO DE COMIDA</caption>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<table>
						<tr>
							<td>POLLO, POLLO BROASTER, ADEREZO BRASA, CARNES, VERDURAS</td>
							<td>--> Producción</td>
						</tr>
						<tr>
							<td>PECHUGA X KG., ALITAS X KG., ANTICUCHO, MOLLEJA X KG.</td>
							<td>--> Almacén</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<p>
						Registrar los <span class="resaltar">REQUERIMIENTOS </span>de las áreas: <span class="resaltar">Producción, Counter, Caja. </span>La fecha del requerimiento no se modifica. <span class="resaltar">Graba y Procesa.</span>
					</p>
				</td>
				<td>
					<div id="item_1" class="item tooltipleft">ruta
			...
			<tr>
				...
				<td><p>Registrar <span class="resaltar">ÓRDENES DE PRODUCCIÓN </span>en el área de <span class="resaltar">??????</span> de:</p>
					...
					<ul>
						...
						<li>Aderezo Broaster</li>
						<li>Salsas (aji, mayonesa, vinagreta, chimichurri, etc</li>
						<li>Causa</li>
					</ul>
					<br />
			...
			<tr>
				...
				<td>
					...
					<ul>
						...
						<li>Pechuga x Kg.-------> Pechuga x 150 gr., Chicharron Pollo Porción.</li>
						<li>Mollejas x Kg.--------> Molleja Unidad.</li>
						<li>Filete Pollo x Kg.-----> Filete Pierna.</li>
					</ul>
				</td>
				<td>
					<div id="item_1" class="item tooltipleft">ruta
			...
			<tr>
				...
				<td><input type="checkbox"></td>
				<td>
					<p>Realizar el <span class="resaltar">REQUERIMIENTO, </span>de <span class="resaltar">Producción, </span>del consumo de <span class="resaltar">Lechuga y Papa. </p>
					<br />
			...
			<tr>
				...
				<td><input type="checkbox"></td>
				<td>
					<p>Realizar la <span class="resaltar">SALIDA, </span>de <span class="resaltar">Producción, </span>del consumo de <span class="resaltar">Carbón. </span></p>
					<br />
					<p>Restar: el Stock Actual (sistema) menos el Stock Final Fisico (finales).</p>
				</td>
				<td>
