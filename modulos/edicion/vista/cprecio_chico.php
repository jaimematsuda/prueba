...
<div>
	...
	<br />
		...
		<input type="textbox" id="vigencia_inicio" name="vigencia_inicio" value="Vigencia inicio" size="8px" />
		&nbsp;
		<input type="textbox" id="vigencia_final" name="vigencia_final" value="Vigencia final" size="8px" />
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
