...
{
	$query = "SELECT tt.tienda_tipo, pl.area, pl.id_plato, pl.plato ".
	"FROM ".
...
{
	$query = "SELECT pd.id_plato, ud.uso_para, ay.detallado ".
	"FROM ".
